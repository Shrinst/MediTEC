...
import org.meditec.meditecserver.model.Comment;
import org.meditec.meditecserver.service.CommentService;
...
public class CommentResource {
	...
	@DELETE
	@Path("{commentId}")
	public void deleteComment(@PathParam("messageId") long messageId, @PathParam("commebtId") long commentId) {
