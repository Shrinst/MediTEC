...
public class BinarySearchClinicalTree {
	...
	public void insert(String key, ClinicalCase clinicalCase) {
		ClinicalCase newNode = new ClinicalCase(clinicalCase.getPatientName(), clinicalCase.getDoctorName(),
				clinicalCase.getDiseases());
	...
	public ClinicalCase update(String key, ClinicalCase clinicalCase) {
		...
		aux.setDoctorName(clinicalCase.getDoctorName());
		aux.setDiseases(clinicalCase.getDiseases());
