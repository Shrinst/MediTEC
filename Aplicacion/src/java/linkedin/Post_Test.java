...
public class Post_Test {
	...
	private static LinkedInProfile sendGet(String access_token) throws Exception {
		...
		String url = "https://api.linkedin.com/v1/people/~:(id,email-address,first-name,last-name,formatted-name,picture-url)?format=json";
		URL obj = new URL(url);
		...
		obj_LinkedInProfile.setFormattedName(jsonObj.getString("formattedName"));
